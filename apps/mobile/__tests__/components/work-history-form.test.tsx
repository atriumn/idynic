...
describe('WorkHistoryForm', () => {
  ...
  it('shows error when start date is empty', async () => {
    ...
    fireEvent.changeText(screen.getByPlaceholderText('Company name'), 'Acme Corp');
    fireEvent.changeText(screen.getByPlaceholderText('Software Engineer'), 'Developer');
    fireEvent.press(screen.getByText('Save'));
  ...
  it('submits form with valid data', async () => {
    ...
    fireEvent.changeText(screen.getByPlaceholderText('Company name'), 'TechCorp');
    fireEvent.changeText(screen.getByPlaceholderText('Software Engineer'), 'Senior Engineer');
    ...
    fireEvent.changeText(screen.getByPlaceholderText('San Francisco, CA'), 'Remote');
  ...
  it('submits venture with correct entry_type', async () => {
    ...
    fireEvent.changeText(screen.getByPlaceholderText('Your Startup Inc.'), 'My Startup');
    fireEvent.changeText(screen.getByPlaceholderText('Founder & CEO'), 'Founder');
  ...
  it('shows error on submit failure', async () => {
    ...
    fireEvent.changeText(screen.getByPlaceholderText('Company name'), 'Company');
    fireEvent.changeText(screen.getByPlaceholderText('Software Engineer'), 'Role');

...
describe('OnboardingPrompt', () => {
  ...
  describe('loading state', () => {
    it('returns null when loading', () => {
      ...
      const { toJSON } = render(<OnboardingPrompt promptKey="after_resume_upload" />);
  ...
  describe('rendering prompts', () => {
    it('renders prompt with title and message', () => {
      ...
      expect(screen.getByText('We found claims about your skills and experience.')).toBeTruthy();
    });
  ...
  describe('interactions', () => {
    ...
    it('navigates to route when secondary action with route is pressed', async () => {
      mockGetPrompt.mockReturnValue({
        ...
        secondaryAction: { label: 'Add Opportunity', route: '/add-opportunity' },
      });

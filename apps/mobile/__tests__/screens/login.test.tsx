...
describe("LoginScreen", () => {
  ...
  it("switches to sign up mode", () => {
    ...
    expect(
      screen.getByText("Enter your invite code to get started"),
    ).toBeTruthy();
  ...
  it("validates invite code in sign up mode", async () => {
    ...
    fireEvent.changeText(
      screen.getByPlaceholderText("Invite code"),
      "VALIDCODE",
    );
    ...
    await waitFor(() => {
      expect(
        screen.getByText("Code validated! Create your account below."),
      ).toBeTruthy();
    });
  });

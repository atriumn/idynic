    ...
    <View style={StyleSheet.absoluteFill} pointerEvents="none">
       ...
       <Svg height="100%" width="100%" style={StyleSheet.absoluteFill}>
        <Defs>
          ...
          <RadialGradient id="indigoGradient" cx="50%" cy="50%" rx="50%" ry="50%">
            <Stop offset="0%" stopColor="#6366f1" stopOpacity={opacity} />
            <Stop offset="100%" stopColor="#6366f1" stopOpacity="0" />
          </RadialGradient>
          <RadialGradient id="primaryGradient" cx="50%" cy="50%" rx="50%" ry="50%">
        ...
        {/* Bottom Left Blob */}
        <Circle cx={0} cy={height} r={width * 0.9} fill="url(#indigoGradient)" />
        
        {/* Center Blob */}
         <Circle cx={width * 0.5} cy={height * 0.5} r={width} fill="url(#primaryGradient)" />
      </Svg>
    </View>
  );
}

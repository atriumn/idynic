...
async function fetchProfile(userId: string): Promise<Profile> {
  ...
  const [
    ...
    supabase
      .from("profiles")
      .select(
        "name, email, phone, location, linkedin, github, website, logo_url, identity_headline, identity_bio, identity_archetype, identity_keywords, identity_matches, identity_generated_at",
      )
      .eq("id", userId)
      .single(),

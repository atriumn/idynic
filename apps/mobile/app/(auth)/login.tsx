    ...
    >
      <View className="flex-1 justify-center px-6">
        ...
        <View className="flex-row mb-6 bg-slate-800 rounded-lg p-1">
          ...
          >
            <Text
              className={`text-center font-medium ${mode === "signin" ? "text-white" : "text-slate-400"}`}
            >
              Sign In
            </Text>
          </Pressable>
          ...
          >
            <Text
              className={`text-center font-medium ${mode === "signup" ? "text-white" : "text-slate-400"}`}
            >
              Sign Up
            </Text>
          </Pressable>
          ...
          <>
            ...
            <Text className="text-slate-500 text-center text-xs mt-4">
              ...
              <Text
                className="underline"
                onPress={() =>
                  Linking.openURL("https://idynic.com/legal/terms")
                }
              >
                Terms of Service
              </Text>{" "}
              ...
              <Text
                className="underline"
                onPress={() =>
                  Linking.openURL("https://idynic.com/legal/privacy")
                }
              >
                Privacy Policy
              </Text>
            ...
            <Pressable onPress={() => setCodeValidated(false)} className="mt-4">
              <Text className="text-slate-500 text-center text-sm">

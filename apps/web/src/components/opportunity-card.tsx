               ...
               <div className="flex items-center gap-4">
                  {mustHaveCount > 0 && (
                    <div className="flex flex-col">
                      <span className="text-lg font-black leading-none">{mustHaveCount}</span>
                      <span className="text-[9px] font-bold text-muted-foreground uppercase">Required</span>
                    </div>
                  )}
                  {niceToHaveCount > 0 && (
                    <div className="flex flex-col">
                      <span className="text-lg font-black leading-none text-muted-foreground">{niceToHaveCount}</span>
                      <span className="text-[9px] font-bold text-muted-foreground uppercase">Bonus</span>
                    </div>
                  )}
               </div>
            </div>

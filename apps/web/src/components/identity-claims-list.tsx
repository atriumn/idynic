...
import { CONTEXTUAL_HELP } from "@idynic/shared";
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-6 px-5 py-4">
                        ...
                        <Tooltip>
                          ...
                          >
                            {parseBold(
                              claim.type === "education" ||
                                claim.type === "certification"
                                ? "Degrees and certifications are **permanent verified sources**."
                                : evidenceCount >= 3
                                  ? "Backed by **3 or more** independent documents."
                                  : evidenceCount === 1
                                    ? "Only one document supports this. **Add a story** to strengthen the signal."
                                    : "Verified by multiple evidence sources.",
                            )}
                          </TooltipContent>
                        </Tooltip>

                        {/* Maturity Badge (Only show if Recent or Legacy) */}
                        {((claim.confidence ?? 0.5) >= 0.85 ||
                          (claim.confidence ?? 0.5) <= 0.4) && (
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <div
                                className={`text-[9px] font-bold px-2 py-0.5 rounded border uppercase tracking-wider ${
                            ...
                            >
                              {parseBold(
                                (claim.confidence ?? 0.5) >= 0.85
                                  ? "Highly **fresh and relevant** experience."
                                  : "This skill hasn't been used recently and its confidence is **decaying**. Add a recent project to refresh it.",
                              )}
                            </TooltipContent>
                          </Tooltip>
                        )}
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <div className="hidden sm:flex flex-col items-end gap-1 w-28 shrink-0 cursor-help">
                          ...
                          <div className="w-full bg-black/30 rounded-full h-1 overflow-hidden border border-white/5">
                            <div
                              ...
                              style={{
                                ...
                                boxShadow: `0 0 8px ${styles.border}60`,
                              }}
                            />
                          </div>
                          <span className="text-[8px] font-mono font-bold tracking-tighter opacity-40 uppercase">
                            Confidence
                          </span>
                        </div>
                      </TooltipTrigger>
                      <TooltipContent side="top" className="max-w-xs">
                        <p className="font-medium mb-1">
                          {CONTEXTUAL_HELP.claimConfidence.title}
                        </p>
                        <div className="text-muted-foreground text-xs leading-relaxed">
                          {parseBold(CONTEXTUAL_HELP.claimConfidence.content)}
                        </div>
                      </TooltipContent>
                    </Tooltip>
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <div className="w-12 flex flex-col items-center gap-1 cursor-help">
                      ...
                      <TooltipContent side="top" className="max-w-xs">
                        <p className="font-medium mb-1">
                          {CONTEXTUAL_HELP.claimEvidence.title}
                        </p>
                        <div className="text-muted-foreground text-xs leading-relaxed">
                          {parseBold(CONTEXTUAL_HELP.claimEvidence.content)}
                        </div>
                      </TooltipContent>
                    </Tooltip>

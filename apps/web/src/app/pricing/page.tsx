...
export default function PricingPage() {
  ...
  const [loadingPlan, setLoadingPlan] = useState<"pro" | "job_search" | null>(
    null,
  );
              ...
              <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto items-stretch">
                ...
                <div className="rounded-2xl border bg-card text-card-foreground shadow-sm p-6 relative flex flex-col">
                  ...
                  <div className="space-y-2">
                    <h3 className="font-semibold text-xl h-7 flex items-center">
                      Free
                    </h3>
                    <p className="text-sm text-muted-foreground">
                      Get started building your identity.
                    </p>
                  </div>
                ...
                <div className="rounded-2xl border bg-card text-card-foreground shadow-sm p-6 relative flex flex-col">
                  ...
                  {currentPlan === "pro" ? (
                    ...
                    <Button
                      ...
                      disabled={
                        loadingPlan !== null || currentPlan === "job_search"
                      }
                    >
                ...
                <div className="rounded-2xl border bg-card text-card-foreground shadow-sm p-8 md:p-12 space-y-8">
                  <div className="space-y-4 text-center">
                    <h3 className="font-semibold text-3xl">
                      Post Jobs, Get Tailored Applicants
                    </h3>
                    <p className="text-lg text-muted-foreground max-w-xl mx-auto">
                      Candidates don&apos;t send generic resumes. They send
                      profiles tailored to your role—with evidence behind every
                      claim.
                    </p>
                  </div>
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                ...
                <AccordionContent>
                  ...
                  keep access to your premium features until the end of your
                  billing period.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-2">
                <AccordionTrigger>
                  How does a tailored profile work?
                </AccordionTrigger>
                <AccordionContent>
                  Paste a job description, and we generate a unique profile page
                  that highlights exactly how your experience matches that
                  role—with evidence from your career to back it up. You share a
                  link, and that&apos;s what they see.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-3">
                <AccordionTrigger>Is my data private?</AccordionTrigger>
                <AccordionContent>
                  Yes. Your data is encrypted and only accessible by you. We
                  never share your profile with anyone unless you explicitly
                  create and share a link. You can revoke access to any shared
                  link at any time.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-5">
                <AccordionTrigger>
                  What&apos;s the difference between Pro and Job Search?
                </AccordionTrigger>
                <AccordionContent>
                  Pro ($100/year) is for ongoing career management—keeping your
                  identity up to date with 15 tailored profiles per month. Job
                  Search ($50/3 months) is for when you&apos;re actively
                  hunting—unlimited everything to maximize your chances during a
                  job search sprint.
                </AccordionContent>
              </AccordionItem>
            </Accordion>

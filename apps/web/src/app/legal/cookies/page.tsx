  ...
  return (
    <div className="space-y-6">
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-semibold tracking-tight">1. What Are Cookies?</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-semibold tracking-tight">2. How We Use Cookies</h2>
        <p>
          We use cookies to enhance your browsing experience, serve personalized content, and analyze our traffic. Specifically, we use cookies for:
        </p>
        <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
          <li><strong>Authentication:</strong> To keep you signed in to your account.</li>
          <li><strong>Security:</strong> To protect your user account and our network.</li>
          <li><strong>Preferences:</strong> To remember your settings and preferences (e.g., theme, language).</li>
          <li><strong>Analytics:</strong> To understand how users interact with our Service and improve its performance.</li>
        </ul>
      </section>

      <section className="space-y-3">
        <h2 className="text-xl font-semibold tracking-tight">3. Types of Cookies We Use</h2>
        ...
        <div className="grid gap-4 mt-4">
          ...
          <div className="border rounded-lg p-4 bg-muted/20">
            ...
            <p className="text-sm text-muted-foreground">
              These cookies allow our website to remember choices you make when you use our website, such as remembering your login details or language preference.
            </p>
          </div>
          
          <div className="border rounded-lg p-4 bg-muted/20">
            <h3 className="font-semibold mb-2">Analytics & Performance Cookies</h3>
            <p className="text-sm text-muted-foreground">
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-semibold tracking-tight">4. Managing Cookies</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-semibold tracking-tight">5. Updates to This Policy</h2>
        <p>

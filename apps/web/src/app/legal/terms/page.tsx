    ...
    <div className="space-y-6">
      ...
      <section className="space-y-3">
        ...
        <p>
          ...
          (&quot;you&quot;) and Idynic (&quot;we,&quot; &quot;us&quot; or
          &quot;our&quot;), concerning your access to and use of the Idynic
          website and mobile application (collectively, the
          &quot;Service&quot;).
        </p>
        <p>
          By accessing the Service, you confirm that you have read, understood,
          and agreed to be bound by all of these Terms of Service. If you do not
      ...
      <section className="space-y-3">
        ...
        <h3 className="text-lg font-medium mt-4">Our IP</h3>
        <p>
          Unless otherwise indicated, the Service is our proprietary property
          and all source code, databases, functionality, software, website
          designs, audio, video, text, photographs, and graphics on the Service
          (collectively, the &quot;Content&quot;) and the trademarks, service
          marks, and logos contained therein are owned or controlled by us or
          licensed to us.
        </p>

        <h3 className="text-lg font-medium mt-4">Your Content</h3>
        <p>
          You retain full ownership of all resumes, documents, and data you
          upload to the Service (&quot;User Content&quot;). By uploading User
          Content, you grant us a non-exclusive, worldwide, royalty-free license
          to use, reproduce, and process your User Content solely for the
          purpose of providing and improving the Service to you (e.g., parsing
          your resume, generating suggestions).
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p>
          Our Service utilizes Artificial Intelligence (&quot;AI&quot;) to
          generate content, suggestions, and insights. You acknowledge that:
        </p>
        <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
          <li>
          ...
          <li>
            ...
            content (e.g., resumes, cover letters) before using it for job
            applications or professional purposes.
          </li>
          <li>
            We do not guarantee that the use of our Service will result in job
      ...
      <section className="space-y-3">
        ...
        <p>
          ...
          for which we make the Service available. Prohibited activities
          include, but are not limited to:
        </p>
        <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
          <li>
            Systematically retrieving data or other content from the Service to
          ...
          <li>
            Using the Service to generate content that is fraudulent, deceptive,
            or misleading.
          </li>
        </ul>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p>
          ...
          provide access to additional features as described on our pricing
          page. By subscribing to a paid plan, you agree to pay the applicable
          fees.
        </p>
        ...
        <p>
          ...
          payment processor. By providing payment information, you represent
          that you are authorized to use the payment method and authorize us to
        ...
        <p>
          ...
          period (monthly or annually, depending on your plan) unless you cancel
          before the renewal date. You will be charged the then-current
          subscription rate upon renewal.
        </p>
        ...
        <p>
          ...
          until the end of your current billing period. No partial refunds will
          be issued for unused time within a billing period.
        </p>

        <h3 className="text-lg font-medium mt-4">Refund Policy</h3>
        <p>
          We offer a 7-day money-back guarantee for new subscriptions. If you
          are not satisfied with the Service, you may request a full refund
          within 7 days of your initial subscription purchase by contacting
          support@idynic.com. Refunds are not available for renewal charges or
          after the 7-day period.
        </p>

        <h3 className="text-lg font-medium mt-4">Price Changes</h3>
        <p>
          We reserve the right to modify subscription pricing at any time. Price
          changes will not affect your current billing period. We will provide
      ...
      <section className="space-y-3">
        ...
        <p>
          We do not warrant that (a) the Service will function uninterrupted,

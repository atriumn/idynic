  ...
  return (
    <div className="space-y-6">
      ...
      <section className="space-y-3">
        ...
        <p>
          These Terms of Service constitute a legally binding agreement made between you, whether personally or on behalf of an entity (&quot;you&quot;) and Idynic (&quot;we,&quot; &quot;us&quot; or &quot;our&quot;), concerning your access to and use of the Idynic website and mobile application (collectively, the &quot;Service&quot;).
        </p>
        <p>
          By accessing the Service, you confirm that you have read, understood, and agreed to be bound by all of these Terms of Service. If you do not agree with all of these terms, then you are expressly prohibited from using the Service and you must discontinue use immediately.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p>
          Unless otherwise indicated, the Service is our proprietary property and all source code, databases, functionality, software, website designs, audio, video, text, photographs, and graphics on the Service (collectively, the &quot;Content&quot;) and the trademarks, service marks, and logos contained therein are owned or controlled by us or licensed to us.
        </p>

        <h3 className="text-lg font-medium mt-4">Your Content</h3>
        <p>
          You retain full ownership of all resumes, documents, and data you upload to the Service (&quot;User Content&quot;). By uploading User Content, you grant us a non-exclusive, worldwide, royalty-free license to use, reproduce, and process your User Content solely for the purpose of providing and improving the Service to you (e.g., parsing your resume, generating suggestions).
        </p>
      </section>
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-semibold tracking-tight">4. AI Services Disclaimer</h2>
        <p>
          Our Service utilizes Artificial Intelligence (&quot;AI&quot;) to generate content, suggestions, and insights. You acknowledge that:
        </p>
        <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
          <li>AI-generated content may not always be accurate, complete, or suitable for your specific needs.</li>
          <li>You are responsible for reviewing and verifying all AI-generated content (e.g., resumes, cover letters) before using it for job applications or professional purposes.</li>
          <li>We do not guarantee that the use of our Service will result in job interviews, offers, or employment.</li>
        </ul>
      </section>

      <section className="space-y-3">
        <h2 className="text-xl font-semibold tracking-tight">5. Prohibited Activities</h2>
        <p>
        ...
        <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
          ...
          <li>Disparaging, tarnishing, or otherwise harming, in our opinion, us and/or the Service.</li>
          <li>Using the Service to generate content that is fraudulent, deceptive, or misleading.</li>
        </ul>
      </section>

...
describe('jaroWinklerSimilarity', () => {
  ...
  it('should return high similarity for similar strings', () => {
    const similarity = jaroWinklerSimilarity('React Development', 'React Developer');
...
describe('findDuplicates', () => {
  ...
  it('should find similar labels above threshold', () => {
    const claims: ClaimForEval[] = [
      ...
      { id: '2', type: 'skill', label: 'React Developer', description: null, created_at: '2024-01-02' },
    ];
  ...
  it('should not flag different labels as duplicates', () => {
    const claims: ClaimForEval[] = [
      { id: '1', type: 'skill', label: 'React', description: null, created_at: '2024-01-01' },
      { id: '2', type: 'skill', label: 'Python', description: null, created_at: '2024-01-02' },
    ];
...
describe('findMissingFields', () => {
  it('should flag claims missing type', () => {
    const claims: ClaimForEval[] = [
      { id: '1', type: null, label: 'React', description: null, created_at: '2024-01-01' },
    ];
  ...
  it('should flag claims missing label', () => {
    const claims: ClaimForEval[] = [
      { id: '1', type: 'skill', label: '', description: null, created_at: '2024-01-01' },
    ];
  ...
  it('should flag claims missing both type and label', () => {
    const claims: ClaimForEval[] = [
      { id: '1', type: null, label: '', description: null, created_at: '2024-01-01' },
    ];
...
describe('runRuleChecks', () => {
  it('should combine duplicate and missing field checks', () => {
    const claims: ClaimForEval[] = [
      { id: '1', type: 'skill', label: 'React', description: null, created_at: '2024-01-01' },
      { id: '2', type: 'skill', label: 'React', description: null, created_at: '2024-01-02' },
      { id: '3', type: null, label: 'Python', description: null, created_at: '2024-01-03' },
    ];
  ...
  it('should return empty array for valid, unique claims', () => {
    const claims: ClaimForEval[] = [
      { id: '1', type: 'skill', label: 'React', description: null, created_at: '2024-01-01' },
      { id: '2', type: 'skill', label: 'Python', description: null, created_at: '2024-01-02' },
      { id: '3', type: 'achievement', label: 'Led team of 5', description: null, created_at: '2024-01-03' },
    ];
...
describe('sampleClaimsForEval', () => {
  ...
  it('should prioritize claims with fewer evidence', () => {
    const claims: ClaimForEval[] = [
      { id: '1', type: 'skill', label: 'Many Evidence', description: null, created_at: '2024-01-01', evidenceCount: 5 },
      { id: '2', type: 'skill', label: 'Few Evidence', description: null, created_at: '2024-01-01', evidenceCount: 1 },
      { id: '3', type: 'skill', label: 'No Evidence', description: null, created_at: '2024-01-01', evidenceCount: 0 },
    ];
  ...
  it('should prioritize newer claims when evidence count is equal', () => {
    const claims: ClaimForEval[] = [
      { id: '1', type: 'skill', label: 'Old', description: null, created_at: '2024-01-01', evidenceCount: 1 },
      { id: '2', type: 'skill', label: 'New', description: null, created_at: '2024-01-10', evidenceCount: 1 },
    ];
  ...
  it('should handle claims with undefined evidenceCount', () => {
    const claims: ClaimForEval[] = [
      { id: '1', type: 'skill', label: 'With Evidence', description: null, created_at: '2024-01-01', evidenceCount: 3 },
      { id: '2', type: 'skill', label: 'Unknown Evidence', description: null, created_at: '2024-01-01' },
    ];

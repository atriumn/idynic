...
describe('extractHighlights', () => {
  ...
  describe('notable companies', () => {
    it('should highlight work at notable companies', () => {
      const workHistory: ExtractedJob[] = [
        createJob({ company: 'Google', start_date: '2020-01-01', end_date: '2023-01-01' }),
      ];
    ...
    it('should not highlight non-notable companies', () => {
      const workHistory: ExtractedJob[] = [
        createJob({ company: 'Random Startup', start_date: '2020-01-01', end_date: '2023-01-01' }),
      ];
    ...
    it('should handle various notable company names', () => {
      ...
      for (const company of companies) {
        const workHistory: ExtractedJob[] = [
          createJob({ company, start_date: '2021-01-01', end_date: '2023-01-01' }),
        ];
        const highlights = extractHighlights([], workHistory);
    ...
    it('should not include tenure less than 1 year', () => {
      const workHistory: ExtractedJob[] = [
        createJob({ company: 'Google', start_date: '2023-06-01', end_date: '2023-12-01' }),
      ];
    ...
    it('should handle jobs without start date', () => {
      const workHistory: ExtractedJob[] = [
        createJob({ company: 'Google', start_date: undefined as unknown as string }),
      ];
    ...
    it('should handle current jobs (no end date)', () => {
      ...
      const workHistory: ExtractedJob[] = [
        createJob({ company: 'Meta', start_date: `${startYear}-01-01`, end_date: undefined }),
      ];
  ...
  describe('certifications', () => {
    it('should include certifications as highlights', () => {
      const evidence: ExtractedEvidence[] = [
        createEvidence({ text: 'AWS Solutions Architect', type: 'certification' }),
  ...
  describe('education', () => {
    it('should include education as highlights', () => {
      const evidence: ExtractedEvidence[] = [
        createEvidence({ text: 'MS in Computer Science, Stanford', type: 'education' }),
  ...
  describe('quantified achievements', () => {
    it('should include achievements with numbers', () => {
      const evidence: ExtractedEvidence[] = [
        createEvidence({ text: 'Increased sales by 50%', type: 'accomplishment' }),
        createEvidence({ text: 'Led team of 10 engineers', type: 'accomplishment' }),
      ];
    ...
    it('should not include achievements without numbers', () => {
      const evidence: ExtractedEvidence[] = [
        createEvidence({ text: 'Improved code quality', type: 'accomplishment' }),
        createEvidence({ text: 'Enhanced team collaboration', type: 'accomplishment' }),
      ];
    ...
    it('should limit quantified achievements to 3', () => {
      const evidence: ExtractedEvidence[] = [
        createEvidence({ text: 'Achievement 1 with 100%', type: 'accomplishment' }),
        createEvidence({ text: 'Achievement 2 with 200%', type: 'accomplishment' }),
        createEvidence({ text: 'Achievement 3 with 300%', type: 'accomplishment' }),
        createEvidence({ text: 'Achievement 4 with 400%', type: 'accomplishment' }),
        createEvidence({ text: 'Achievement 5 with 500%', type: 'accomplishment' }),
      ];

      const highlights = extractHighlights(evidence, []);
      const achievementHighlights = highlights.filter((h) => h.type === 'achievement');
  ...
  describe('combined highlights', () => {
    it('should combine all types of highlights', () => {
      ...
      const workHistory: ExtractedJob[] = [
        createJob({ company: 'Google', start_date: '2019-01-01', end_date: '2023-01-01' }),
      ];
    ...
    it('should limit total highlights to 6', () => {
      ...
      const workHistory: ExtractedJob[] = [
        createJob({ company: 'Google', start_date: '2019-01-01', end_date: '2023-01-01' }),
        createJob({ company: 'Meta', start_date: '2015-01-01', end_date: '2019-01-01' }),
      ];

...
const mockLinks = [
  ...
  },
  {
    ...
    label: "Glassdoor listing",
    type: "glassdoor" as const,
  },
  {
  ...
  {
    url: "https://greenhouse.io/jobs/789",
    label: null,
...
describe("SmartLinksList", () => {
  it("renders list of links", () => {
    render(
      <SmartLinksList links={mockLinks.slice(0, 2)} onRemove={() => {}} />,
    );
  ...
  it("calls onRemove when delete button clicked", () => {
    ...
    render(
      <SmartLinksList links={mockLinks.slice(0, 2)} onRemove={onRemove} />,
    );
  ...
  it("removes correct link when multiple exist", () => {
    const onRemove = vi.fn();
    render(
      <SmartLinksList links={mockLinks.slice(0, 3)} onRemove={onRemove} />,
    );
  ...
  it("renders all links in order", () => {
    render(
      <SmartLinksList links={mockLinks.slice(0, 4)} onRemove={() => {}} />,
    );
  ...
  it("shows full URL on hover", () => {
    render(
      <SmartLinksList links={mockLinks.slice(0, 1)} onRemove={() => {}} />,
    );

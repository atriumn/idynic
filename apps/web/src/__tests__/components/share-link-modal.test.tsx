...
describe('ShareLinkModal', () => {
  ...
  describe('without existing link', () => {
    ...
    it('creates a new link', async () => {
      ...
      const user = userEvent.setup()
      render(<ShareLinkModal tailoredProfileId="profile-123" onLinkCreated={onLinkCreated} />)
  ...
  describe('with existing active link', () => {
    ...
    it('shows active link interface', async () => {
      ...
      expect(screen.getByText(/your share link is active/i)).toBeInTheDocument()
    ...
    it('revokes link', async () => {
      ...
      const user = userEvent.setup()
      render(<ShareLinkModal tailoredProfileId="profile-123" existingLink={existingLink} onLinkRevoked={onLinkRevoked} />)
  ...
  describe('with expired link', () => {
    ...
    it('shows expired state', async () => {
      const user = userEvent.setup()
      render(<ShareLinkModal tailoredProfileId="profile-123" existingLink={expiredLink} />)
  ...
  describe('with revoked link', () => {
    ...
    it('shows revoked state', async () => {
      const user = userEvent.setup()
      render(<ShareLinkModal tailoredProfileId="profile-123" existingLink={revokedLink} />)
